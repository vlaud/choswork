...
namespace Rito.InputBindings
{
    ...
    public class InputBinding
    {
        ...
        ***********************************************************************/
        ...
        {
            Bind(UserAction.Throw, KeyCode.Mouse0);

            Bind(UserAction.Attack, KeyCode.F);
            Bind(UserAction.Run, KeyCode.LeftShift);
            Bind(UserAction.Interact, KeyCode.E);
            Bind(UserAction.UseItem, KeyCode.T);

            Bind(UserAction.Camera, KeyCode.V);
            Bind(UserAction.Debug, KeyCode.C);
            Bind(UserAction.UI_Inventory, KeyCode.I);
            Bind(UserAction.Escape, KeyCode.Escape);

            Bind(UserAction.JournalLeft, KeyCode.Mouse0);
            Bind(UserAction.JournalRight, KeyCode.Mouse1);
        }
